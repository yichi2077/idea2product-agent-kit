...
It consolidates current phase and mode, the next step, gate states, the decisions already recorded, open assumptions and risks, and any stale outputs. Summarize it for the user; you operate the pipeline, the user does not type these commands.
